...
static const _ListenResult_type_support_symbol_names_t _ListenResult_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, qbo_msgs, msg, ListenResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, qbo_msgs, msg, ListenResult)),
  }
};
...
{
  return &::qbo_msgs::msg::rosidl_typesupport_cpp::ListenResult_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, qbo_msgs, msg, ListenResult)() {
  return get_message_type_support_handle<qbo_msgs::msg::ListenResult>();
}
