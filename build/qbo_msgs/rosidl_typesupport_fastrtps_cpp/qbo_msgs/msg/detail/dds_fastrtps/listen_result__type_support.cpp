...
#include "qbo_msgs/msg/detail/listen_result__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = qbo_msgs::msg::ListenResult;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const qbo_msgs::msg::ListenResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<qbo_msgs::msg::ListenResult *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ListenResult__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const qbo_msgs::msg::ListenResult *>(
...
static size_t _ListenResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ListenResult(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ListenResult__callbacks = {
  "qbo_msgs::msg",
  "ListenResult",
...
static rosidl_message_type_support_t _ListenResult__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ListenResult__callbacks,
...
{
  return &qbo_msgs::msg::typesupport_fastrtps_cpp::_ListenResult__handle;
}
