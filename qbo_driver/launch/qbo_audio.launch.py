...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument("audio_in", default_value="jabra", description="Nom du périphérique micro (entrée)"),
        DeclareLaunchArgument("audio_out", default_value="usb", description="Nom du périphérique haut-parleur (sortie)"),
        DeclareLaunchArgument("lang", default_value="fr", description="Langue système initiale"),
        DeclareLaunchArgument("volume", default_value="30", description="Volume initial du playback"),
