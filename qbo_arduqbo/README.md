...
```bash
ros2 service call /head_pan_joint/torque_enable qbo_msgs/srv/TorqueEnable   "{enable: false}"

ros2 service call /head_tilt_joint/torque_enable qbo_msgs/srv/TorqueEnable   "{enable: false}"
```
